...
# Tasks
t1 = Task.create(title: "Hire Designer", description: "Get someone with an awesome portfolio who can make this site great!", due_date: DateTime.new(2021,7,11), status: "in progress", project_id: website.id)
t2 = Task.create(title: "Hire Engineer", description: "We need a Rails backend and a React frontend, choose accordingly.", due_date: DateTime.new(2021,4,12), status: "not started", project_id: website.id)
t3 = Task.create(title: "Mockup", description: "Draw out what the site should look like.", due_date: DateTime.new(2021,8,1), status: "completed", project_id: website.id)
t4 = Task.create(title: "Promotional Topic", description: "Brainstorm to plan what we should promote.", due_date: DateTime.new(2021,4,14), status: "in progress", project_id: ad.id)
t5 = Task.create(title: "Scout locations", description: "Find a site to film commercial.", due_date: DateTime.new(2021,11,18), status: "in progress", project_id: commercial.id)
t6 = Task.create(title: "Film", description: "Shoot the commercial.", due_date: DateTime.new(2021,6,17), status: "not started", project_id: commercial.id)
t7 = Task.create(title: "Plan Questions", description: "Write a list of questions to include in the survey.", due_date: DateTime.new(2021,5,6), status: "in progress", project_id: survey.id)
t8 = Task.create(title: "Create Survey", description: "Enter approved questions into survey sheet.", due_date: DateTime.new(2021,6,1), status: "in progress", project_id: website.id)
t9 = Task.create(title: "Distribute", description: "Send survey to recent customers.", due_date: DateTime.new(2021,3,21), status: "not started", project_id: survey.id)
